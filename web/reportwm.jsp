...
<div style="margin-top: 20px; padding: 50px;">
    ...
    <div style="overflow:auto">
        ...
        <table>
            <tr>
                <td class="td-caption"> מספר אירוע: </td>
                <td><%out.print(srId);%></td>
            </tr>
            <tr>
        ...
        <tr>
            ...
            <div style= "padding: 15px; white-space: pre-wrap; border: 1px solid #ddd;"><%out.print(description);%></div>
        </tr>
        ...
        <%
            ...
            try {
                ...
                while(rs != null &&  rs.next())  {
                    ...
                    if(rs.getInt("sr_cust_hugsha_tluna") > 0 ){
        ...
        <table id = "meoravtable" class="stylingtable">
            ...
            <%
                ...
                try {
                    ...
                    while(rs != null &&  rs.next())  {
                        isysaiditem++;
                        meorav = (rs.getString("user_name") == null)? "" :rs.getString("user_name");
                        s_prati = (rs.getString("first_name") == null)? "" :rs.getString("first_name");
                        s_mish = (rs.getString("last_name") == null)? "" :rs.getString("last_name");
                        sug_m =  (rs.getString("cause_item") == null)? "" :rs.getString("cause_item");
